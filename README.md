...
# 0261springboot基于spring boot的小型诊疗预约平台的设计与开发
...
## 1.2 目的和意义
信息数据的处理完全依赖人工进行操作，会耗费大量的人工成本，特别是面对大量的数据信息时，传统人工操作不仅不能对数据的出错率进行保证，还容易出现各种信息资源的低利用率与低安全性问题。更有甚者，耽误大量的宝贵时间，尤其是对信息的更新，归纳与统计更是耗财耗力的过程。所以电子化信息管理的出现就能缓解以及改变传统人工方式面临的处境，一方面可以确保信息数据在短时间被高效处理，还能节省人力成本，另一方面可以确保信息数据的安全性，可靠性，并可以实现信息数据的快速检索与修改操作，这些优点是之前的旧操作模式无法比拟的。因此小型诊疗预约平台为数据信息的管理模式的升级与改革提供了重要的窗口。
## 1.3 论文结构安排
...
![C:\Users\Administrator\Desktop\img\xiaoxingzhenliaoyuyuepingtai\药品.jpg](/md/blog.009.jpeg "C:\Users\Administrator\Desktop\img\xiaoxingzhenliaoyuyuepingtai\药品.jpg")
图4.1 药品实体属性图

（2）下图是公告信息实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\xiaoxingzhenliaoyuyuepingtai\公告信息.jpg](/md/blog.010.jpeg "C:\Users\Administrator\Desktop\img\xiaoxingzhenliaoyuyuepingtai\公告信息.jpg")
图4.2 公告信息实体属性图

（3）下图是医生预约挂号订单实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\xiaoxingzhenliaoyuyuepingtai\医生预约挂号订单.jpg](/md/blog.011.jpeg "C:\Users\Administrator\Desktop\img\xiaoxingzhenliaoyuyuepingtai\医生预约挂号订单.jpg")
图4.3 医生预约挂号订单实体属性图

（4）下图是医生收藏实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\xiaoxingzhenliaoyuyuepingtai\医生收藏.jpg](/md/blog.012.jpeg "C:\Users\Administrator\Desktop\img\xiaoxingzhenliaoyuyuepingtai\医生收藏.jpg")
图4.4 医生收藏实体属性图

（5）下图是病例实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\xiaoxingzhenliaoyuyuepingtai\病例.jpg](/md/blog.013.jpeg "C:\Users\Administrator\Desktop\img\xiaoxingzhenliaoyuyuepingtai\病例.jpg")
图4.5 病例实体属性图

（6）下图是患者实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\xiaoxingzhenliaoyuyuepingtai\患者.jpg](/md/blog.014.jpeg "C:\Users\Administrator\Desktop\img\xiaoxingzhenliaoyuyuepingtai\患者.jpg")
图4.6 患者实体属性图

（7）下图是医生实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\xiaoxingzhenliaoyuyuepingtai\医生.jpg](/md/blog.015.jpeg "C:\Users\Administrator\Desktop\img\xiaoxingzhenliaoyuyuepingtai\医生.jpg")
图4.7 医生实体属性图

（8）下图是单页数据实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\xiaoxingzhenliaoyuyuepingtai\单页数据.jpg](/md/blog.016.jpeg "C:\Users\Administrator\Desktop\img\xiaoxingzhenliaoyuyuepingtai\单页数据.jpg")
图4.8 单页数据实体属性图

（9）下图是医生留言实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\xiaoxingzhenliaoyuyuepingtai\医生留言.jpg](/md/blog.017.jpeg "C:\Users\Administrator\Desktop\img\xiaoxingzhenliaoyuyuepingtai\医生留言.jpg")
图4.9 医生留言实体属性图
...
|4|bingli\_uuid\_number|String|病例编号|是|
|5|bingli\_name|String|病例名称|是|
|6|bingli\_address|String|现住址|是|
|7|bingli\_jiguan|String|籍贯|是|
|8|bingli\_hunyin|String|婚姻状况|是|
|9|zhusu\_content|String|主诉|是|
|10|jiwangshi\_content|String|既往史|是|
|11|geren\_content|String|个人史|是|
|12|yichuan\_content|String|家族遗传史|是|
|13|zhenduan\_content|String|医生诊断|是|
|14|yaofang\_content|String|开具药方|是|
|15|kanbing\_time|Date|看病时间|是|
|16|jiaofei\_jine|BigDecimal|缴费金额|是|
|17|insert\_time|Date|录入时间|是|
|18|jiaofei\_types|Integer|是否缴费|是|
...
|6|huanzhe\_email|String|电子邮箱|是|
...
|7|yaopin\_content|String|药品详细介绍|是|
|8|create\_time|Date|创建时间|是|
表4.7医生表
...
|4|yisheng\_phone|String|医生手机号|是|
|5|yisheng\_id\_number|String|医生身份证号|是|
|6|yisheng\_photo|String|医生头像|是|
|7|yisheng\_shanchang|String|医生擅长|是|
|8|keshi\_types|Integer|科室|是|
|9|zhiwei\_types|Integer|职位|是|
|10|guahaofei|BigDecimal|挂号费|是|
|11|zan\_number|Integer|赞|是|
|12|cai\_number|Integer|踩|是|
|13|yisheng\_content|String|医生详细介绍|是|
...
|2|yisheng\_id|Integer|医生|是|
|3|huanzhe\_id|Integer|患者|是|
|4|yisheng\_liuyan\_text|String|留言内容|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|yisheng\_order\_uuid\_number|String|预约挂号编号|是|
|3|yisheng\_id|Integer|医生|是|
|4|huanzhe\_id|Integer|患者|是|
|5|yisheng\_order\_true\_price|BigDecimal|实付价格|是|
|6|yisheng\_order\_types|Integer|挂号状态|是|
|7|kanbing\_time|Date|预约看病日期|是|
|8|shijianduan\_types|Integer|看病时间段|是|
|9|yisheng\_order\_payment\_types|Integer|支付类型|是|
|10|insert\_time|Date|挂号时间|是|
